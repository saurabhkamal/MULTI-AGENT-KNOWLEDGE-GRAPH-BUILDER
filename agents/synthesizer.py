...
def run_synthesizer(raw_data: dict):
    ...
    prompt = f"""
You are an expert career roadmap planner and exclusive education advisor.

When users ask about  courses or preparation strategies, recommend from the top 3 platforms.
